...
CKEDITOR.editorConfig = function (config) {
    ...
    config.extraPlugins = 'onchange,font,liststyle,dialog,dialogui,clipboard,pastefromword,colorbutton,justify,list,indent,indentlist,indentblock,showborders,dinavier';
